...
#####################################
CONFIG_DIR=${HOME}/SageMaker/lifecycle-config/config
...
pip install jupyter-server-proxy pylint autopep8 yapf pyflakes pycodestyle nbconvert==5.6.1 jedi==0.18.1 'python-language-server[all]'
